...
def collect_doctor_urls():
    """
    Thu thập tất cả URLs của bác sĩ từ trang chuyên gia y tế Vinmec cho đến khi không tìm thấy thêm bác sĩ nào nữa.
    """
    ...
    # Thu thập từ trang 2 đến trang 30
    for page_num in range(2, 111):  # 2 đến 110
        if page_num == 2:
    ...
    if unique_urls:
        ...
        output_data = {
            ...
            "collected_from_pages": list(range(2, 111)),
        ...
        print(f"📄 Đã kiểm tra: {110} trang (trang 2-110)")
